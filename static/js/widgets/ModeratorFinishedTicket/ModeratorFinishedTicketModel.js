...
const ModeratorFinishedTicketModel = ({
  dataList,
  total,
  currentPage,
  onPageChange,
  ...
  let columns = [
    ...
    },
    {
      ...
      key: "lockedTime",
      // moment.unix() is used to compare dateTime. Unix() returns the number of seconds since the Unix Epoch
    ...
    {
      title: t("Submitted Time"),
      dataIndex: "submittedTime",
      key: "submittedTime",
      // moment.unix() is used to compare dateTime. Unix() returns the number of seconds since the Unix Epoch
      sorter: (a, b) => moment(a.submittedTime).unix() - moment(b.submittedTime).unix(),
      render: (utcSubmittedTime) => {
        return converUtcToLocal(utcSubmittedTime);
      },
    },
    {
      title: t("Review Time"),
  ...
  return (
    <Table
      ...
      size="small"
      style={{ marginTop: 24 }}
      rowKey={(moderator) => moderator.ticketId}
      pagination={{
        total,
        current: currentPage,
        pageSize: pageSize,
...
export default ModeratorFinishedTicketModel;
