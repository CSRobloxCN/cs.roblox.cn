...
const DisplayNameOnlineRescanCard = ({ pool, picker,onTicketQuery }) => {
    ...
    return (
      <>
        <Button
          ...
          onClick={() =>
            history.push(
              `/batch-update?templateType=${ModerationEvents.DisplayNameOnlineRescanEvent.name}`
            )
          }
        >
          {t("Locked tickets")}
...
export default DisplayNameOnlineRescanCard;
